...
- **[Informs'25]** Causally-Aware Spatio-Temporal Multi-Graph Convolution Network for Accurate and Reliable Traffic Prediction [[pdf]](https://arxiv.org/abs/2408.13293) (Forecasting, Uncertainty quantification, Information fusion)
...
- **[ICLR'20]** Estimating Counterfactual Treatment Outcomes over Time Through Adversarially Balanced Representations [[pdf]](https://arxiv.org/abs/2002.04083)[[code]](https://github.com/ioanabica/Counterfactual-Recurrent-Network) (Treatment effects estimation, Counterfactual Outcome Modeling, Recurrent Outcome Simulator)
- **[ICML'20]** Time Series Deconfounder: Estimating Treatment Effects over Time in the Presence of Hidden Confounders [[pdf]](https://arxiv.org/abs/1902.00450)[[code]](https://github.com/ioanabica/Time-Series-Deconfounder) (Treatment effects estimation)
- **[NeurIPS'18]** Forecasting treatment responses over time using recurrent marginal structural networks [[pdf]](https://papers.nips.cc/paper_files/paper/2018/hash/56e6a93212e4482d99c84a639d254b67-Abstract.html)[[code]](https://github.com/sjblim/rmsn_nips_2018) (Treatment effects estimation)
...
-  **[TPAMI'23]** Transferable time-series forecasting under causal conditional shift [[pdf]](https://ieeexplore.ieee.org/document/10214679) [[code]](https://github.com/DMIRLAB-Group/GCA) (Time Series, Granger Causality, Transfer Learning, Semi-Supervised Domain Adaptation)
...
- **[NeurIPS'22]** Temporally Disentangled Representation Learning [[pdf]](https://arxiv.org/abs/2210.13647)[[code]](https://github.com/weirayao/tdrl)
...
- **[NeurIPS'13]** Causal Inference on Time Series using Restricted Structural Equation Models [[pdf]](https://proceedings.neurips.cc/paper_files/paper/2013/file/47d1e990583c9c67424d369f3414728e-Paper.pdf) (Time series causal inference, Structural equation models, Causal discovery)
...
- **[NeurIPS'23 Workshop Paper]** Towards Causal Representations of Climate Model Data [[pdf]](https://arxiv.org/abs/2312.02858)
